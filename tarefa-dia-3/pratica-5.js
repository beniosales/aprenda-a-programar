...
let rLen = receita.length;

let totValor = 0;
let totGorgeta = 0;

let nVendas1 = 0; //numero de vendas, sem gorjeta, abaixo de 50
let nVendas2 = 0; //numero de vendas, incluindo gorjeta, acima de 50

for (i = 0; i < rLen; i++){
    totValor = totValor + receita[i].valor;
    totGorgeta = totGorgeta + receita[i].gorjeta;
...
let total = totValor + totGorgeta;

/* PROBLEMA 1: Qual o valor total de vendas sem gorjeta? --------------------- */
//COLOQUE SUA SOLUÇÃO AQUI
console.log(`Valor total de vendas, sem gorjeta: R$${parseFloat(totValor)}`);

/* ----------------------------------------------------------------------------- */

/* PROBLEMA 2: Qual o valor total de vendas incluindo a gorjeta? --------------- */
//COLOQUE SUA SOLUÇÃO AQUI
console.log(`Valor total de vendas, incluindo gorjeta: R$${parseFloat(total)}`);

/* ----------------------------------------------------------------------------- */

/* PROBLEMA 3: Quantas vendas foram abaixo de 50 reais? ----------------------- */
//COLOQUE SUA SOLUÇÃO AQUI
console.log(`Numero de vendas abaixo de 50: ${nVendas1}`);
console.log(`Numero de vendas abaixo de 50 (incluindo gorjeta): ${nVendas2}`);
